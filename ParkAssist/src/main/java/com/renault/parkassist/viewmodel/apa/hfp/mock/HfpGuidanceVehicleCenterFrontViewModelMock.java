...
public class HfpGuidanceVehicleCenterFrontViewModelMock extends HfpGuidanceVehicleCenterFrontViewModelBase {
	public HfpGuidanceVehicleCenterFrontViewModelMock(@NonNull Application application) {
		super(application);
		this.reset();
	}
	...
	public void reset() {
		...
		stopFrontVisible.setValue(false);
	}
	...
	public void postReset() {
		...
		stopFrontVisible.postValue(false);
	}
	...
	@NonNull
	@Override
	public MutableLiveData<Boolean> getStopFrontVisible() {
		return stopFrontVisible;
	}
	...
	protected MutableLiveData<Boolean> stopFrontVisible = new MutableLiveData<>();
