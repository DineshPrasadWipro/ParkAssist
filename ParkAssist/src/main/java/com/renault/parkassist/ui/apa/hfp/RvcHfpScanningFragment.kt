...
class RvcHfpScanningFragment : HfpScanningFragment() {

    override val settingsAction = R.id.action_to_sonarHfpSettingsFragment
    ...
    override fun onCreateView(
        ...
        return super.onCreateView(inflater, container, savedInstanceState)
            .also { it?.setTag(R.id.uxTag, it.context.getString(R.string.hfp_scanning_rvc_ux)) }
    }
    ...
    override fun onBind() {
        ...
        childFragmentManager.commit {
            add(R.id.hfp_scanning_sonar_full_fragment_container, SonarFullFragment())
        }

        hfpScanningViewModel.sonarRvcVisible.observe {
