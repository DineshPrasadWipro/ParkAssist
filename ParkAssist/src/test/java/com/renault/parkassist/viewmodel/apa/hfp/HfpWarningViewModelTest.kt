...
@SmallTest
class HfpWarningViewModelTest : ApaWarningViewModelTest() {

    private lateinit var hfpWarningViewModel: HfpWarningViewModel
    ...
    override fun setup() {
        ...
        hfpWarningViewModel = HfpWarningViewModel()
        hfpWarningViewModel.dialogBox.observe(lifecycleOwner, Observer {
            testedDialogBox = it
        })
    }
    ...
    override fun tearDown() {
        super.tearDown()
        hfpWarningViewModel.dialogBox.removeObservers(lifecycleOwner)
        testedDialogBox = null
    }

    @Test
    fun `should return disabled dialog when NONE message is received`() { // ktlint-disable max-line-length
    ...
    fun `should return enabled dialog with positive button when MANEUVER_CANCELED message is received`() { // ktlint-disable max-line-length
        ...
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_POSITIVE, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
    ...
    fun `should return enabled dialog with neutral button when MANEUVER_SUSPENDED_DOOR_OPEN message is received`() { // ktlint-disable max-line-length
        ...
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_NEUTRAL, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }
    ...
    @Test
    fun `should return enabled dialog with neutral button when MANEUVER_SUSPENDED_UNTIL_RESTART_ENGINE message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return enabled dialog with neutral button when MANEUVER_SUSPENDED_BRAKE_TO_STOP message is received`() { // ktlint-disable max-line-length
    ...
    fun `should return enabled dialog with neutral button when MANEUVER_UNAVAILABLE_HAND_ON_WHEEL message is received`() { // ktlint-disable max-line-length
        val msg = MESSAGE_MANEUVER_UNAVAILABLE_HAND_ON_WHEEL
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_NEUTRAL, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }
    ...
    @Test
    fun `should return enabled dialog with neutral button when MANEUVER_UNAVAILABLE_ENGINE_STOPPED message is received`() { // ktlint-disable max-line-length
        val msg = MESSAGE_MANEUVER_UNAVAILABLE_ENGINE_STOPPED
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_POSITIVE, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }
    ...
    @Test
    fun `should return enabled dialog with neutral button when FEATURE_UNAVAILABLE_REAR_GEAR_ENGAGED message is received`() { // ktlint-disable max-line-length
        val msg = MESSAGE_FEATURE_UNAVAILABLE_REAR_GEAR_ENGAGED
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_POSITIVE, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }
    ...
    fun `should return enabled dialog with positive and negative button when PRESS_OK_TO_START_MANEUVER message is received`() { // ktlint-disable max-line-length
        ...
        val expectedDialogBox =
            getExpectedHfpDialogBox(DIALOG_BOX_TYPE_POSITIVE_NEGATIVE, true, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }

    @Test
    fun `should return disabled dialog when FEATURE_UNAVAILABLE_MIRRORS_FOLDED message is received`() { // ktlint-disable max-line-length
        val msg = MESSAGE_FEATURE_UNAVAILABLE_MIRRORS_FOLDED
        val expectedDialogBox = getExpectedHfpDialogBox(DIALOG_BOX_TYPE_DISABLED, false, msg)
        apaRepositoryWarningMessage.postValue(msg)
        Assert.assertEquals(expectedDialogBox, testedDialogBox)
    }

    @Test
    fun `should return disabled dialog when MANEUVER_CANCELED_MIRRORS_FOLDED message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when MANEUVER_CANCELED_GEAR_SHIFT_ACTIVATED message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when MANEUVER_CANCELED_RELEASE_ACCELERATOR_PEDAL message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when MANEUVER_SUSPENDED_GEAR_SHIFT_ACTIVATED message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when MANEUVER_SUSPENDED_RELEASE_ACCELERATOR_PEDAL message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when FEATURE_UNAVAILABLE_VEHICLE_NOT_STOPPED message is received`() { // ktlint-disable max-line-length
    ...
    @Test
    fun `should return disabled dialog when BRAKE_TO_RESUME_MANEUVER message is received`() { // ktlint-disable max-line-length
